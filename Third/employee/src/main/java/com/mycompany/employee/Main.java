...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        version3.Employee n = new version3.Employee(new Date(2012, 26, 21), new Date(2052, 28, 42), new Name("Kenny", "Maratas", "Ma"),  23000003);
        n.displayEmployeeDetails();
        
        System.out.println("============ COMMISSION EMPLOYEE ============\n");
        System.out.println("======= Constructor 1");
        version3.CommissionEmployee x = new CommissionEmployee(new Date(2352, 48, 43), new Date(2042, 22, 21), new Name("KennyW", "MaratasA", "Ma4"), 2354303, 5432);
        x.displayCommissionEmployee();
        
        System.out.println("\n======= Constructor 2");
        version3.CommissionEmployee x1 = new CommissionEmployee();
        ...
        System.out.println("\n======= Constructor 3");
        CommissionEmployee x2 = new CommissionEmployee(new Name("CEKenny2", "DWA", "OMFGGG"), 765345);
